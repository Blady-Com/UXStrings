...
package UXStrings is
   ...
   type Constant_Reference_Type (Element : not null access constant Unicode_Character) is private with
     Implicit_Dereference => Element;
   type Reference_Type (Element : not null access Unicode_Character) is private with
     Implicit_Dereference => Element;
   function Constant_Reference (Container : aliased UXString; Index : Positive) return Constant_Reference_Type;
   function Reference (Container : aliased in out UXString; Index : Positive) return Reference_Type;
   function Constant_Reference (Container : aliased UXString; Position : Cursor) return Constant_Reference_Type;
   function Reference (Container : aliased in out UXString; Position : Cursor) return Reference_Type;

   package UXString_Iterator_Interfaces is new Ada.Iterator_Interfaces (Cursor, Has_Element);
   function Iterate (Container : UXString) return UXString_Iterator_Interfaces.Reversible_Iterator'Class;
   function Iterate
     (Container : UXString; Start : Cursor) return UXString_Iterator_Interfaces.Reversible_Iterator'Class;

   function Empty (Capacity : Natural := 10) return UXString;
   function New_String (First, Last : Positive) return UXString;
...
private
   ...
   type Constant_Reference_Type (Element : not null access constant Unicode_Character) is null record;

   type Reference_Type (Element : not null access Unicode_Character) is null record;

   type Unicode_Character_Access is access Unicode_Character_Array;
   type UXString is new Ada.Finalization.Controlled with record
      Chars     : Unicode_Character_Access := new Unicode_Character_Array (2 .. 1);
   ...
   No_Element : constant Cursor := Cursor'(null, Positive'First);
   ...
   Null_UXString : constant UXString :=
     (Ada.Finalization.Controlled with Chars => new Unicode_Character_Array (2 .. 1), Finalized => False);
