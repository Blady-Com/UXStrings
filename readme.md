...
A fourth proof of concept implementation is provided. The source code files are ending with the number 4 as for instance "uxstrings4.ads". A GNAT project file "uxstrings4.gpr" is provided with some naming conventions for both packages UXStrings  and UXStrings.Text\_IO.
...
UXStrings3 is default chosen implementation.

You might choose an other implementation 1, 2, 3 or 4 by editing the config GPR `config/your_crate_config.gpr` and
comment out the ones not chosen:
```
--  Configuration for test_uxstrings generated by Alire
--with "lib_uxstrings1.gpr";
--with "lib_uxstrings2.gpr";
with "lib_uxstrings3.gpr";
--with "lib_uxstrings4.gpr";
abstract project Test_Uxstrings_Config is
```
